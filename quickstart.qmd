---
title: "Integre rapidamente"
---

## Objetivo

Sair do zero até uma credencial verificável funcionando em ambiente de desenvolvimento.

## Checklist

| # | Etapa | Tempos típicos | Resultado esperado |
|---|-------|-------|-------------------|
...
// Presentation Definition para credencial verificável
...
<OpenID4VPVerification
  ...
  onVpProcessed={(results) => {
    ...
    console.log('CCIR verificado:', verificado);
  }}
