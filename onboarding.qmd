...
| Presentation Definition | `PRESENTATION_DEFINITION` no `verifyService.ts` | Define quais credenciais solicitar (`CCIRCredential`, `CARReceipt`, `CARDocument`) |
...
Entre em contato com o órgão responsável pelas Credenciais Verificáveis.
...
O processo de onboarding é gerenciado pelo órgão responsável pelas Credenciais Verificáveis. Consulte a documentação fornecida no credenciamento.
