...
Implementar uso de credenciais verificáveis em um app web mobile usando Deep Link (fluxo same-device).
...
sequenceDiagram
    ...
    U->>SDK: Toca "Verificar Documentos de Crédito Rural"
...
<OpenID4VPVerification
  ...
  onError={(error) => {
    ...
    alert('Instale a Carteira Digital para verificar seus documentos de Crédito Rural.');
  }}
/>
```
